-- Snow Admin 初始化 SQL（MySQL 5.7+）
-- 使用方法：mysql -u root -p snow_admin < prisma/init.sql

CREATE DATABASE IF NOT EXISTS `snow_admin` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `snow_admin`;
